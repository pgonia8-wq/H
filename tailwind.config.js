  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ── Semantic tokens HSL (Trade shell fullscreen, ref token/) ──
        // Permiten usar bg-background, text-foreground, bg-card, border-border, etc.
        // SIN romper los colores humans-* / accent-* existentes.
