  ...
  return (
    <div className="grid grid-cols-4 gap-2 px-4 py-3">
      ...
      <div className="stat-card items-center">
        ...
        <span className="text-sm font-bold text-green-400">{fmtUsd(totalMcap, { compact: true })}</span>
      </div>
      <div className="stat-card items-center">
        <span className="text-[9px] text-muted-foreground font-medium uppercase tracking-wider">24h Vol</span>
        <span className="text-sm font-bold text-foreground">{fmtUsd(totalVol, { compact: true })}</span>
      </div>
      <div className="stat-card items-center">
