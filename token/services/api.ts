import type {
  ...
  export interface InitiateBuyResult {
    orderId: string;
    reference: string;
    amountWld: number;
  ...
  export interface ConfirmBuyRequest {
    orderId: string;
  ...
  export const api = {
    ...
    async initiateBuy(body: InitiateBuyRequest): Promise<InitiateBuyResult> {
      return request<InitiateBuyResult>("/initiateBuy", {
        method: "POST",
        body: JSON.stringify(body),
      });
    },

    async confirmBuy(body: ConfirmBuyRequest): Promise<BuyResult> {
      return request<BuyResult>("/confirmBuy", {
        method: "POST",
        body: JSON.stringify(body),
      });
    },
