...
-- 2. TOKENS
-- ─────────────────────────────────────────────
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_wpepe','WorldPepe','WPEPE','🐸','usr_pgonia_01','pgonia',0.000035329999999999995,0.00010598999999999998,4769.5500,136,27.2475,15.3,245,100000000,45000000,'The first meme token on World Chain',true,ARRAY['Meme','Hot']::text[],72,544.950000,8.297668,false,now()-interval '21 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_mdust','MoonDust','MDUST','🌙','usr_pgonia_01','pgonia',0.0000029767999999999996,0.000008930399999999998,107.1648,22,0.7954,5.7,38,100000000,12000000,'Lunar vibes, infinite potential',false,ARRAY['New','Community']::text[],60,15.907200,0.291376,false,now()-interval '14 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_orbcoin','OrbCoin','ORBC','🔮','usr_pgonia_01','pgonia',0.0000666168,0.0001998504,12390.7248,185,69.8707,22.1,890,100000000,62000000,'Only verified humans',true,ARRAY['Blue Chip','Verified']::text[],81,1397.413867,24.179753,false,now()-interval '25 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_hyperh','HyperH','HYPH','⚡','usr_pgonia_01','pgonia',7.107e-7,0.0000021321000000000003,7.4623,9,0.0998,-2.1,12,100000000,3500000,'Speed matters. Built for H',false,ARRAY['New','Social']::text[],45,1.995817,0.039658,false,now()-interval '3 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_dhand','DiamondHands','DHAND','💎','usr_pgonia_01','pgonia',0.0000139848,0.0000419544,1174.7232,80,6.9929,8.9,156,100000000,28000000,'Never selling. Community of believers',true,ARRAY['Community','Diamond']::text[],68,139.858133,1.489395,false,now()-interval '18 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_solara','Solara','SOLAR','☀️','usr_luna_02','luna_trader',0.00005253,0.00015759,8667.4500,281,49.0692,18.5,520,100000000,55000000,'Solar-powered degens',true,ARRAY['Hot','Energy']::text[],77,981.383333,10.622329,false,now()-interval '22 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_nocturne','Nocturne','NOCT','🦇','usr_luna_02','luna_trader',0.0000016008,0.0000048024,38.4192,24,0.3468,3.2,22,100000000,8000000,'Night owls unite',false,ARRAY['New','Night']::text[],55,6.935467,0.099091,false,now()-interval '7 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_alpha','AlphaDAO','ALPHA','🧠','usr_max_03','max_alpha',0.000025336799999999998,0.0000760104,2888.3952,162,16.6800,12.4,310,100000000,38000000,'Governance for alpha hunters',true,ARRAY['DAO','Governance']::text[],70,333.599467,6.299236,false,now()-interval '20 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_apex','ApexRun','APEX','🏔️','usr_max_03','max_alpha',0.0000043700000000000005,0.000013110000000000002,196.6500,50,1.3425,6.8,67,100000000,15000000,'Race to the top',false,ARRAY['Gaming','Compete']::text[],62,26.850000,0.450042,false,now()-interval '10 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_rosa','RosaCoin','ROSA','🌹','usr_sofia_04','sofia.eth',0.0000088248,0.000026474400000000002,582.4368,86,3.6024,-1.5,44,100000000,22000000,'Beauty in decentralization',false,ARRAY['Art','Beauty']::text[],48,72.048533,1.050967,false,now()-interval '15 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_fuego','Fuego','FUEG','🔥','usr_diego_05','diego_wld',0.0000777108,0.00023313240000000002,15619.8708,157,87.8937,31.2,1100,100000000,67000000,'On fire. Unstoppable',true,ARRAY['Hot','Fire']::text[],88,1757.874533,19.247998,false,now()-interval '26 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_hielo','IceAge','ICE','🧊','usr_diego_05','diego_wld',9.3e-7,0.00000279,13.9500,32,0.1608,0.3,8,100000000,5000000,'Cool heads prevail',false,ARRAY['New','Chill']::text[],50,3.216667,0.041827,false,now()-interval '4 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_pixel','PixelWorld','PIXL','🎮','usr_mia_06','mia_crypto',0.0000192308,0.0000576924,1903.8492,67,11.1269,9.7,178,100000000,33000000,'Gaming meets DeFi',true,ARRAY['Gaming','Pixel']::text[],65,222.538800,4.109390,false,now()-interval '17 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_vibe','VibeCheck','VIBE','✨','usr_mia_06','mia_crypto',0.000008085199999999998,0.000024255599999999995,509.3676,34,3.1798,3.8,48,100000000,21000000,'Only good vibes',false,ARRAY['Community','Vibe']::text[],58,63.596400,0.933999,false,now()-interval '11 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_luna','LunarDAO','LNAO','🌕','usr_carlos_07','carlos_moon',0.0000308408,0.0000925224,3885.9408,86,22.2886,4.1,95,100000000,42000000,'Decentralized lunar fund',false,ARRAY['DAO','Space']::text[],58,445.771200,7.968388,false,now()-interval '19 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_crater','CraterCoin','CRTR','🕳️','usr_carlos_07','carlos_moon',5.387e-7,0.0000016161,2.4242,10,0.0385,-5.2,4,100000000,1500000,'From the depths',false,ARRAY['New','Deep']::text[],35,0.769350,0.011462,false,now()-interval '2 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_nftape','ApeNFT','ANFT','🦍','usr_elena_08','elena_nft',0.000040128799999999994,0.00012038639999999998,5778.5472,86,32.9030,14.8,380,100000000,48000000,'Apes together strong',true,ARRAY['NFT','Community']::text[],73,658.060800,7.205660,false,now()-interval '23 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_canvas','CanvasDAO','CNVS','🎨','usr_elena_08','elena_nft',0.0000060728,0.000018218399999999998,327.9312,69,2.1218,2.9,51,100000000,18000000,'Art governance',false,ARRAY['Art','DAO']::text[],56,42.436800,0.803812,false,now()-interval '12 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_yolo','YoloCoin','YOLO','🎲','usr_jake_09','jake_diamond',0.000047008799999999996,0.0001410264,7333.3728,172,41.6076,25.6,670,100000000,52000000,'You only live once',true,ARRAY['Meme','YOLO']::text[],82,832.152533,14.472149,false,now()-interval '24 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_zen','ZenToken','ZEN','🧘','usr_nina_10','nina_degen',0.0000121272,0.0000363816,945.9216,38,5.6885,1.8,35,100000000,26000000,'Find your inner peace',false,ARRAY['Wellness','Zen']::text[],52,113.769067,1.189339,false,now()-interval '13 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_chaos','ChaosDAO','CHAOS','🌀','usr_nina_10','nina_degen',0.00002802,0.00008406,3362.4000,105,19.3467,-3.4,88,100000000,40000000,'Embrace the chaos',false,ARRAY['DAO','Chaos']::text[],42,386.933333,7.409635,false,now()-interval '16 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_mate','MateCoin','MATE','🧉','usr_pablo_11','pablo_sol',0.0000067092,0.0000201276,382.4244,31,2.4412,7.3,62,100000000,19000000,'Fueled by mate',false,ARRAY['LatAm','Community']::text[],64,48.824933,0.933530,false,now()-interval '9 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_fomo','FomoCoin','FOMO','😱','usr_pablo_11','pablo_sol',0.0000563828,0.0001691484,9641.4588,149,54.5137,20.4,580,100000000,57000000,'Dont miss out',true,ARRAY['Meme','FOMO']::text[],79,1090.273200,21.093763,false,now()-interval '20 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_hodl','HodlForever','HODL','🫡','usr_anna_12','anna_hodl',0.00005836079999999999,0.0001750824,10154.7792,256,57.3821,11.2,430,100000000,58000000,'We dont sell. Period',true,ARRAY['Diamond','HODL']::text[],75,1147.642133,18.655531,false,now()-interval '22 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_devtool','DevTools','DEVT','🛠️','usr_tomas_13','tomas_dev',0.0000013428,0.0000040284,28.1988,23,0.2733,0.9,15,100000000,7000000,'Built by devs for devs',false,ARRAY['Dev','Tools']::text[],53,5.466533,0.088998,false,now()-interval '6 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_debug','DebugCoin','DBUG','🐛','usr_tomas_13','tomas_dev',5.688e-7,0.0000017063999999999999,3.4128,14,0.0523,-0.7,6,100000000,2000000,'Fix bugs earn tokens',false,ARRAY['New','Dev']::text[],47,1.045867,0.013521,false,now()-interval '3 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_globe','GlobeToken','GLBE','🌍','usr_iris_14','iris_world',0.00002157,0.00006471,2264.8500,162,13.1658,5.5,120,100000000,35000000,'One world one token',false,ARRAY['Global','UBI']::text[],61,263.316667,5.068318,false,now()-interval '18 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_rocket','RocketFuel','RKTF','🚀','usr_leo_15','leo_pump',0.00007095119999999999,0.00021285359999999998,13622.6304,284,76.7479,28.7,950,100000000,64000000,'Fueling the next moonshot',true,ARRAY['Hot','Rocket']::text[],85,1534.958933,17.808729,false,now()-interval '27 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_pump','PumpItUp','PUMP','💪','usr_leo_15','leo_pump',0.0000170292,0.000051087599999999995,1583.7156,146,9.3151,19.3,290,100000000,31000000,'Only up never down',true,ARRAY['Meme','Pump']::text[],74,186.301733,3.154883,false,now()-interval '15 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_brick','BrickByBrick','BRCK','🧱','usr_val_16','val_builder',0.0000038712,0.0000116136,162.5904,17,1.1366,3.6,42,100000000,14000000,'Building one block at a time',false,ARRAY['Build','Infra']::text[],57,22.732267,0.344212,false,now()-interval '8 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_banana','BananaCoin','BNNA','🍌','usr_marco_17','marco_ape',0.0000323028,0.00009690839999999999,4167.0612,130,23.8670,16.9,340,100000000,43000000,'Apes love bananas',true,ARRAY['Meme','Ape']::text[],71,477.340133,7.784633,false,now()-interval '19 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_jungle','JungleDAO','JNGL','🌴','usr_marco_17','marco_ape',0.0000018932,0.0000056796,51.1164,25,0.4340,4.5,28,100000000,9000000,'Welcome to the jungle',false,ARRAY['DAO','Wild']::text[],54,8.679600,0.167027,false,now()-interval '5 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_gem','HiddenGem','HGEM','💠','usr_sara_18','sara_gem',0.0000025812,0.0000077436,85.1796,36,0.6566,8.1,55,100000000,11000000,'The gem you were looking for',false,ARRAY['Alpha','Gem']::text[],63,13.131067,0.157831,false,now()-interval '7 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_orbit2','OrbitDAO','ORBT','🪐','usr_dan_19','dan_orbit',0.000024046799999999998,0.0000721404,2669.1948,104,15.4455,6.2,98,100000000,37000000,'Decentralized space governance',false,ARRAY['DAO','Space']::text[],59,308.910533,3.662033,false,now()-interval '16 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_bag','BagHolder','BAGS','💰','usr_lucia_20','lucia_bag',0.0000435,0.0001305,6525.0000,130,37.0833,13.5,410,100000000,50000000,'We hold bags with pride',true,ARRAY['Meme','Community']::text[],69,741.666667,7.506027,false,now()-interval '21 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_stack','StackSats','STAK','📚','usr_lucia_20','lucia_bag',7.752e-7,0.0000023256000000000002,9.3024,19,0.1183,1.2,10,100000000,4000000,'Stack tokens like books',false,ARRAY['New','Stack']::text[],51,2.366933,0.039758,false,now()-interval '4 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_whale','WhaleAlert','WHAL','🐋','usr_rafa_21','rafa_whale',0.0000823892,0.0002471676,17054.5644,211,95.8976,35.8,1500,100000000,69000000,'Only whales allowed',true,ARRAY['Whale','Hot']::text[],90,1917.951600,26.351685,false,now()-interval '28 days')
  ON CONFLICT (id) DO NOTHING;
INSERT INTO tokens (id,name,symbol,emoji,creator_id,creator_name,price_wld,price_usdc,market_cap,holders,curve_percent,change_24h,volume_24h,total_supply,circulating_supply,description,is_trending,tags,buy_pressure,total_wld_in_curve,treasury_balance,graduated,created_at)
  VALUES ('tok_shrimp','ShrimpCoin','SHRP','🦐','usr_rafa_21','rafa_whale',0.0000049032,0.000014709599999999999,235.3536,74,1.5742,2.3,33,100000000,16000000,'Small but mighty',false,ARRAY['Community','Small']::text[],55,31.483733,0.422692,false,now()-interval '10 days')
  ON CONFLICT (id) DO NOTHING;
