...
const translations: Record<Language, Translations> = {
  es: {
    ...
    tab_mine: "Mis posts",
    no_posts_following: "Sigue a alguien para ver sus posts aquí",
    no_posts_mine: "Aún no has publicado nada",
    no_posts_global: "No hay posts todavía",
    acceso_prioritario: "Acceso prioritario",
    nivel_maximo_vip: "Nivel máximo VIP",
    upgrade: "✦ Upgrade",
    error_upgrade: "Error en el upgrade",
    upgrade_exitoso: "Upgrade exitoso a",
  },
  en: {
    // --- PostCard / Feed ---
    seguir: "Follow",
    ...
    tab_mine: "My posts",
    no_posts_following: "Follow someone to see their posts here",
    no_posts_mine: "You haven't posted anything yet",
    no_posts_global: "No posts yet",
    acceso_prioritario: "Priority access",
    nivel_maximo_vip: "Max VIP level",
    upgrade: "✦ Upgrade",
    error_upgrade: "Upgrade error",
    upgrade_exitoso: "Upgrade successful to",
  },
};
